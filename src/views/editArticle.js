...
export class EditArticle extends React.Component {
    ...
    async componentDidMount() {
        let article_id = qs.parse(this.props.location.search, { ignoreQueryPrefix: true }).article;
        let res = await axios.get('/api/getArticleContentById', {params: {article_id}});
        await this.setState({previewContent: res.data.content, title: res.data.title, article_id});
    }
    ...
    handleSubmit = async (e) => {
        ...
        if (this.state.saveOrSubmit === "save") {
            url = '/api/saveExistingArticle'
        } else if (this.state.saveOrSubmit === "submit") {
            url = '/api/submitExistingArticle'
        }
            ...
            <div className='container'>
                <div className='row my-5'>
                                ...
                                <div className="modal-body">
                                    <form>
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="formGroupExampleInput" value={this.state.title}
                    ...
                    <div className='col-md-8' >
                        <h3 className='mb-3'>Title: {this.state.title}</h3>
                        <Editor
                            initialValue={this.state.previewContent}
                            init={{
                                height: 750,
                                menubar: true,
                                plugins: [
                    ...
                    <div className='col-md-4'>
                        <div className="marvel-device iphone-x scale--08" style={{top:'-40px'}}>
                            <div className="notch">
